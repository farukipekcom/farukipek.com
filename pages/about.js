            ...
            <div className={styles.details}>
              <div className={styles.left}>
                <h2 className={styles.heading2}>
                  My interest in web development started in 2013 when I started
                  my own website. I learned a lot about HTML & CSS after
                  discovering Wordpress. <br />
                  <br />
              ...
              <div className={styles.right}>
                <p className={styles.text}>
                  Outside of programming, I love designing, cycling and
                  traveling. Some of photos can be found on Instagram. <br />
                  <br />
